...
const HomeApplianceProductSlider = ({ homeAppliance }) => {
  ...
  return (
    <HomeWrapper>
      <Container className="fluid-container">
        <h2 className="m-5">Tv & Home Appliances</h2>
        <Slider {...settings}>
          {
                  ...
                  <Col>
                    ...
                    >
                      ...
                      <div className="price__category">
                        ...
                        <p className="product__price">
                          Category: <strong>Home Appliances</strong>
                        </p>
                      </div>
                    </Link>
                    <Button
...
export default HomeApplianceProductSlider;
